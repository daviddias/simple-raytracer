...
const Parser = (function () {
  Parser.prototype.objectify = function (pairs) {
    let hash, key, value, _i, _len, _ref
    hash = {}
  ...
  Parser.prototype.parseBlock = function () {
    let convert, key, line, name, params, values
    ...
    params = this.objectify(function () {
      let _i, _len, _ref, _ref1, _results
      _results = []
      while (line = this.lines.shift()) {
        if (line === '}') {
          break
        }
        _ref = line.split(/\s+/), key = _ref[0], values = _ref.length >= 2 ? __slice.call(_ref, 1) : []
        _ref1 = this.convert
